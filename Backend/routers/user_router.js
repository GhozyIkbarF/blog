...
import { register, getUser, updateUser, updatePassword, login, logout } from '../controllers/user.controller.js';
...
user_router.patch('/user/edit/password/:id', changePasswordValidation, updatePassword);
